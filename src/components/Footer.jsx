      ...
      <footer className="footer">
        <div className="footer_block">
          <div className="footer_column">
            <h4 style={{ paddingBottom: "10px" }}>Навігація </h4>
            <Link to={"/"}>
          ...
          <div className="footer_column">
            <h4 style={{ paddingBottom: "10px" }}>Наше місце розташування</h4>
            <h3 className="no_style">вул. Незалежної України, 47/7</h3>
            <h3>
              <a
                style={{ color: "white" }}
                target="_blank"   
          ...
          <div className="footer_column">
            <h4 style={{ paddingBottom: "10px" }}>Соціальні мережі</h4>
